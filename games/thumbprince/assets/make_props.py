...
# ---- painting (14x12, wall-mounted) ----
p = P(14, 12)
p.rect(0, 0, 13, 11, (110, 74, 42))
p.hl(1, 12, 0, (150, 104, 58))
p.rect(2, 2, 11, 9, (70, 100, 150))
p.rect(3, 6, 10, 9, (70, 130, 80))            # hills
p.px(5, 3, (240, 235, 200)); p.px(9, 4, (226, 200, 120))
add("painting", p)

# ---- window (12x12, wall-mounted) ----
p = P(12, 12)
p.rect(0, 0, 11, 11, (86, 66, 44))
p.rect(2, 2, 9, 9, (120, 170, 210))
p.rect(2, 8, 9, 9, (90, 130, 170))
p.vl(5, 2, 9, (60, 46, 32)); p.vl(6, 2, 9, (60, 46, 32))
p.hl(2, 9, 5, (60, 46, 32))
