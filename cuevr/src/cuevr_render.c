...
"    // half a centimetre.\n"
"    float cav = length(nap_lean(pos, nrm, span * 0.34)) * 0.65\n"
"              + length(nap_lean(pos, nrm, span * 0.11)) * 0.35;\n"
...
"    // Three times finer again. At 32 mm the coarsest octave in the stack is\n"
"    // 4 mm, and 4 mm blobs on baize are coarse however subtle they are — the\n"
...
"        float lost = lean_lost(v_local, nv, 0.011);\n"
...
"        float mocc = nap_occlusion(v_local, nv, 0.011);\n"
