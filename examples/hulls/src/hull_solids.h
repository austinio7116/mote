...
static const MeshFace cube_rf[12] = {
    {4,5,6, 0,0,127},  {4,6,7, 0,0,127},
    {1,0,3, 0,0,-127}, {1,3,2, 0,0,-127},
    {5,1,2, 127,0,0},  {5,2,6, 127,0,0},
    {0,4,7,-127,0,0},  {0,7,3,-127,0,0},
    {7,6,2, 0,127,0},  {7,2,3, 0,127,0},
    {0,1,5, 0,-127,0}, {0,5,4, 0,-127,0},
};
static const uint16_t cube_rfc[12] = {   /* per-face shade (subtle faux-AO) */
    MOTE_RGB565(238,236,226), MOTE_RGB565(238,236,226),
    MOTE_RGB565(206,204,196), MOTE_RGB565(206,204,196),
    MOTE_RGB565(224,222,212), MOTE_RGB565(224,222,212),
    MOTE_RGB565(196,194,186), MOTE_RGB565(196,194,186),
    MOTE_RGB565(246,244,234), MOTE_RGB565(246,244,234),
    MOTE_RGB565(184,182,174), MOTE_RGB565(184,182,174),
};
static const Mesh cube_rmesh = { cube_rv, cube_rf, cube_rfc, 8, 12, 0, 1.0f, 1.74f, 0 };
...
static const uint16_t oct_rfc[8] = {   /* per-face gem facets */
    MOTE_RGB565(120,220,245), MOTE_RGB565(92,196,226),
    MOTE_RGB565(106,210,236), MOTE_RGB565(82,182,216),
    MOTE_RGB565(100,205,232), MOTE_RGB565(86,189,221),
    MOTE_RGB565(96,200,229),  MOTE_RGB565(76,176,211),
};
static const Mesh oct_rmesh = { oct_rv, oct_rf, oct_rfc, 6, 8, 0, 1.0f, 1.0f, 0 };
