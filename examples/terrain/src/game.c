...
static const MeshFace k_cube_f[12] = {
    {4,5,6,0,0,127},{4,6,7,0,0,127}, {1,0,3,0,0,-127},{1,3,2,0,0,-127},
    {5,1,2,127,0,0},{5,2,6,127,0,0}, {0,4,7,-127,0,0},{0,7,3,-127,0,0},
    {7,6,2,0,127,0},{7,2,3,0,127,0}, {0,1,5,0,-127,0},{0,5,4,0,-127,0},
};
static const uint16_t k_cube_fc[12] = { CB,CB, CB,CB, CR,CR, CR,CR, CG,CG, CG,CG };
static const Mesh k_cube_mesh = { k_cube_v, k_cube_f, k_cube_fc, 8, 12, 0, 1.0f, 1.8f, 0 };
