 ...
 * Mote port: allocated from the engine arena (with the world) and injected via
 * craft_render_set_zbuf(), keeping the module's static BSS under its 128 KB
 * region. Indexing a pointer is identical to indexing the array. */
uint8_t *craft_zbuf;
